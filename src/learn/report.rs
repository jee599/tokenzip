...
pub fn format_console_report(
    ...
    output.push_str(&format!(
        "ContextZip Learn -- {} rules from {} corrections ({} sessions, {} days)\n",
        rules.len(),
        total_corrections,
        sessions,
        days
...
pub fn write_rules_file(rules: &[CorrectionRule], path: &str) -> Result<()> {
    ...
    content.push_str("# CLI Corrections (auto-generated by contextzip learn)\n");
    content.push_str("# Run `contextzip learn --write-rules` to update\n\n");
